...
judul_soal = {'penjumlahan':3, 'pengurangan':1}
tingkat_kesulitan = {'penjumlahan':'Mudah', 'pengurangan':'Sulit'} 
soal = ["1+1 = ", "2+2 = ", "3 x 3 = ", "3-1"]
jawaban = ['A', 'A', 'C', 'B']
deskJawaban = [('2', '3', '4'), ('4', '5', '6'), ('2', '3', '9'), ['1', '2', '8']]
penjelasan = ['a','b','c','d']
judul_dipilih = ''

judulEsai={'a':3, 'b':1}
kesulitanEsai={'a':'Mudah', 'b':'Sulit'}
soalEsai=['aaaaaaaaaaa', 'bbbbbbbbbbbbb', 'ccccccccccccc', 'dddddddddddddd']
jawabanEsai=['1', '2', '3', '4']
deskEsai=[]
judul_dipilihEsai=''
